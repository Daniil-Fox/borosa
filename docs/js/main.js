...
/* harmony import */ var _components_header_scroll_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/header-scroll.js */ "./src/js/components/header-scroll.js");
/* harmony import */ var _components_privacy_policy_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/privacy-policy.js */ "./src/js/components/privacy-policy.js");
/* harmony import */ var _components_header_sec_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/header-sec.js */ "./src/js/components/header-sec.js");
/* harmony import */ var _components_browser_scroll_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/browser-scroll.js */ "./src/js/components/browser-scroll.js");
...
document.addEventListener("DOMContentLoaded", () => {
  (0,_components_browser_scroll_js__WEBPACK_IMPORTED_MODULE_10__.initBrowserScroll)();
});
...
aos__WEBPACK_IMPORTED_MODULE_0__.init({
  ...
  anchorPlacement: window.innerWidth > 768 ? "center-bottom" : "top-bottom" // defines which position of the element regarding to window should trigger the animation
});
setTimeout(() => {
...
/***/ "./src/js/components/browser-scroll.js":
/*!*********************************************!*\
  !*** ./src/js/components/browser-scroll.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initBrowserScroll: () => (/* binding */ initBrowserScroll)
/* harmony export */ });
const initBrowserScroll = () => {
  // Находим элемент с атрибутом data-auto-scroll="true"
  const browserContentContainer = document.querySelector('.browser-content[data-auto-scroll="true"]');
  if (!browserContentContainer) {
    console.log('Контейнер .browser-content[data-auto-scroll="true"] не найден');
    return;
  }
  const browserContent = browserContentContainer.querySelector(".browser-content__body");
  if (!browserContent) {
...
/***/ "./src/js/components/header-sec.js":
/*!*****************************************!*\
  !*** ./src/js/components/header-sec.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
const initPortfolioMore = () => {
  ...
  if (!portfolioContainer || !moreButton || !hideButton || !portfolioSection) return;
  ...
  const scrollToShowNextSection = () => {
    ...
    const portfolioBottom = portfolioSection.getBoundingClientRect().bottom + window.scrollY;
    const viewportHeight = window.innerHeight;

    // Вычисляем позицию скролла так, чтобы от текущей секции было видно только 100px
    const scrollPosition = portfolioBottom - viewportHeight + VISIBLE_PORTFOLIO_PART;
    window.scrollTo({
      top: scrollPosition,
      behavior: "smooth"
    });
...
/***/ "./src/js/components/privacy-policy.js":
/*!*********************************************!*\
  !*** ./src/js/components/privacy-policy.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initPrivacyPolicyHandlers: () => (/* binding */ initPrivacyPolicyHandlers)
/* harmony export */ });
...
const initPrivacyPolicyHandlers = () => {
  ...
  forms.forEach(form => {
    ...
    const privacyCheckbox = form.querySelector('.form__agree input[type="checkbox"]');
...
swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination]);
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".build__slider", {
  slidesPerView: "auto",
  spaceBetween: 5,
  centeredSlides: true,
  speed: 600,
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".princeps__slider", {
  slidesPerView: 1,
  spaceBetween: 30,
  loop: true,
  speed: 500,
...
if (vericalSliderContainer.length > 0) {
  vericalSliderContainer.forEach(el => {
    ...
    if (thumbsSlider) {
      thumbsS = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(thumbsSlider, {
        slidesPerView: 3,
        direction: "vertical",
        spaceBetween: 20,
        loop: true,
    ...
    const generalSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(mainSlider, {
      slidesPerView: 1,
      spaceBetween: 20,
      effect: "fade",
      fadeEffect: {
...
if (listalkaWrapper.length > 0) {
  listalkaWrapper.forEach(wrap => {
    ...
    const sliderrr = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(slider, {
      slidesPerView: 1,
      spaceBetween: 20,
      navigation: {
        prevEl: btnPrev,
    ...
    function updateCustomPagination(swiper) {
      ...
      pagination.style.setProperty("--pagination-offset", percent * swiper.realIndex + "%");
    }
  });
}
...
const initTooltips = () => {
  ...
  const tooltipTriggers = document.querySelectorAll(".methods__wrpaper > span:first-child");
  ...
  tooltipTriggers.forEach((trigger, index) => {
    const tooltip = trigger.closest(".methods__wrpaper").querySelector(".methods__tooltip");
    if (tooltip) {
      // Создаем экземпляр Popper для каждого тултипа
      const popperInstance = (0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(trigger, tooltip, {
        placement: "top",
        modifiers: [{
          name: "offset",
          options: {
  ...
  document.addEventListener("click", e => {
    ...
    if (!target.closest(".methods__wrpaper > span:first-child") && !target.closest(".methods__tooltip")) {
      closeAllTooltips();
    }
  });
...
if (document.querySelector(".cta__form")) {
  (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".cta__form", rules1, checks, afterForm);
}
if (document.querySelector("#modal-cta")) {
  (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)("#modal-cta form", rules2, [{
    selector: ".form__agree",
    errorMessage: "Выберите чекбоксы"
  }], afterForm);
}
if (document.querySelector("#modal-cons")) {
  (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)("#modal-cons form", rules3, [{
    selector: ".form__agree",
    errorMessage: "Выберите чекбоксы"
  }], afterForm);
}
...
const validateForms = (selector, rules, checkboxes = [], afterSend) => {
  ...
  if (telSelector) {
    const inputMask = new inputmask_dist_inputmask_es6_js__WEBPACK_IMPORTED_MODULE_1__["default"]("+7 (999) 999-99-99", {
  ...
  validation.onSuccess(ev => {
    ...
    const path = location.origin + "/wp-content/themes/borosa/assets/mail.php";
